export const routes = [
  ...
  ["GET", "/catalog/products", "products", true],
  ["POST", "/catalog/products", "createProduct", true],
  ["PATCH", "/catalog/products/:id", "updateProduct", true],
  ["GET", "/catalog/campaigns", "campaigns", true],
  ["POST", "/catalog/campaigns", "createCampaign", true],
  ["POST", "/catalog/campaigns/:id/enroll", "enrollCampaign", true],
  ["GET", "/orders", "orders", true],
  ["POST", "/orders", "createOrder", true],
  ["POST", "/orders/:id/submit", "submitOrder", true],
  ...
  ["POST", "/activities/:id/cancel", "cancelActivity", true],
